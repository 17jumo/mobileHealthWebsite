                                ...
                                <div class="checkout-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="textarea" class="form-control @error('course_desc_short') is-invalid @enderror"
                                                   id="course_desc_short" name="course_desc_short" value="" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label for="course_desc_long">Description - Long</label>
                                            <input type="textarea" class="form-control @error('course_desc_long') is-invalid @enderror"
